...
const copyright = {
  logo: "/assets/img/logo/Bella_name_Logo.png",
  copyright_text: (
    <>Copyright © Bella Training Institute {new Date().getFullYear()}, All Rights Reserved</>
  ),
};
    ...
    <>
      <footer>
        ...
        >
              ...
              <div className="row">
                ...
                <div className="col-xl-4 col-lg-6 col-md-8">
                  <div className="footer-widget footer-col-4  mb-50">
                    ...
                    <p>
                      Be the first one to know about Registration, offers and
          ...
          <div className="f-copyright pt-20 pb-20">
            <div className="container">
              <div className="row">
                <div className="col-md-5">
                  <div className="f-copyright__logo ">
                    <a href="#">
                ...
                <div className="col-md-7 ce">
                  <div className="f-copyright__text text-md-end mb-30 align-items center">
